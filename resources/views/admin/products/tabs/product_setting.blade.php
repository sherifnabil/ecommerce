    ...
    <div id="product_setting" class="tab-pane fade">
        ...
        <div class="form-group col-md-4 col-lg-3 col-sm-4 col-xs-12">
            ...
            {!! Form::text('start_at', $product->start_at, ['class' => 'form-control datepicker text-center', 'placeholder' =>  trans('admin.start_at')]) !!}
        </div>
        <div class="form-group col-md-4 col-lg-3 col-sm-4 col-xs-12">
            {!! Form::label('end_at', trans('admin.end_at')) !!}
            {!! Form::text('end_at', $product->end_at, ['class' => 'form-control datepicker text-center', 'placeholder' =>  trans('admin.end_at')]) !!}
        </div>
        ...
        <div class="form-group col-md-6 col-lg-4 col-sm-6 col-xs-12">
            ...
            {!! Form::text('start_offer_at', $product->start_offer_at, ['class' => 'form-control datepicker text-center', 'placeholder' =>  trans('admin.start_offer_at')]) !!}
        </div>
        <div class="form-group col-md-6 col-lg-4 col-sm-6 col-xs-12">
            {!! Form::label('end_offer_at', trans('admin.end_offer_at')) !!}
            {!! Form::text('end_offer_at', $product->end_offer_at, ['class' => 'form-control datepicker text-center', 'placeholder' =>  trans('admin.end_offer_at')]) !!}
        </div>
        <div class="clearfix" ></div>
        ...
        <div class="form-group">
            ...
            {!! Form::select('status', ['pending' => trans('admin.pending'), 'refused' => trans('admin.refused'), 'active' => trans('admin.active')], old('status') , ['class' => 'form-control status', 'placeholder' =>  trans('admin.status')]) !!}
        </div>
